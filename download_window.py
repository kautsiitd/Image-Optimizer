...
class download_window(Frame):
    ...
    def initUI(self,parent):
        ...
        # creating buttons
        self.b1 	= Button  (self.parent, text="From:"   , command= self.dwld_dir,		   state="active", font='serif 10')
        self.b1.grid		  (row = 0 	  , column = 0	   , padx 	= 5)
        self.b1.bind		  ('<Return>' 			       ,		  self.dwld_dir)
        self.b2 	= Button  (self.parent, text=" To: "   , command= self.to_save,			   state="active", font='serif 10')
        self.b2.grid		  (row = 1 	  , column = 0	   , padx	= 5			  , sticky = "ew")
        self.b2.bind		  ('<Return>' 			       ,		  self.to_save)
        ...
        self.b4 	= Button  (self.parent, text="Download", command= self.s3_dwld,			   state="active", font='serif 10')
        self.b4.grid		  (row = 2 	  , column = 2	   , padx	= 5			  , sticky = "ew")
        self.b4.bind		  ('<Return>' 			       ,		  self.s3_dwld)
    ...
    def to_save(self, *args):
		...
		options['title'] = 'Download_To Directory'
